...
<!-- Carousel -->
    ...
    <div class="container">
   <div class="jumbotron">
  <span class="glyphicon glyphicon-object-align-bottom"></span><h1>Aplicaciones de Escritorio!</h1>
  <p> </p>
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="img/appes1.jpg" alt="...">
      <div class="caption">
        <h3>Aplicacion 1</h3>
        <p>Es aquella que se encuentra instalado en el ordenador o sistema de almacenamiento (USB) y podemos ejecutarlo sin internet en nuestro sistema operativo</p>
